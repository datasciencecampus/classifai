...
##### Pip
```bash
pip install "classifai[<dependency list(s)>] @ https://github.com/datasciencecampus/classifai/releases/download/v<version e.g. 1.1.0>/classifai-<version e.g. 1.1.0>-py3-none-any.whl"
```

##### Astral UV
One-off add to environment:
```bash
uv pip install "classifai[<dependency list(s)>] @ https://github.com/datasciencecampus/classifai/releases/download/v<version e.g. 1.1.0>/classifai-<version e.g. 1.1.0>-py3-none-any.whl"
```
Persist as an environment requirement:
```bash
uv add "classifai[<dependency list(s)>] @ https://github.com/datasciencecampus/classifai/releases/download/v<version e.g. 1.1.0>/classifai-<version e.g. 1.1.0>-py3-none-any.whl"
```
